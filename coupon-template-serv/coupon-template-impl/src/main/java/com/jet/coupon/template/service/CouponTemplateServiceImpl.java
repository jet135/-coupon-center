package com.jet.coupon.template.service;
...
import com.jet.coupon.template.api.enums.CouponType;
import com.jet.coupon.template.api.intf.CouponTemplateService;
import com.jet.coupon.template.converter.CouponTemplateConverter;
import com.jet.coupon.template.dao.CouponTemplateDao;
import com.jet.coupon.template.dao.entity.CouponTemplate;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public List<CouponTemplateInfo> searchTemplate(CouponTemplateInfo request) {
        com.jet.coupon.template.dao.entity.CouponTemplate example = com.jet.coupon.template.dao.entity.CouponTemplate.builder()
                .shopId(request.getShopId())
                .category(CouponType.convert(request.getType()))
                .available(request.getAvailable())
                .name(request.getName())
...
//        templateDao.findAll(Example.of(example), page);
        List<com.jet.coupon.template.dao.entity.CouponTemplate> result = templateDao.findAll(Example.of(example));
    ...
    public Map<Long, CouponTemplateInfo> getTemplateInfoMap(Collection<Long> ids) {
        ...
        List<com.jet.coupon.template.dao.entity.CouponTemplate> templates = templateDao.findAllById(ids);
